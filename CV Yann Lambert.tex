...
\section{Expériences}
\cventry{Depuis 2014}{Ingénieur Système GNU/Linux}{Numericable-SFR}{Saint-Denis}{}{Au sein de l'Ingénierie Système Grand Public, j'ai eu à mettre en place ou faire évoluer différentes plateformes, en collaboration avec les demandeurs.
\begin{itemize}
...
\item Gestion de l'équipe réalisant l'opération de migration de la messagerie
\item Reporting de l'avancement de la migration de la messagerie
