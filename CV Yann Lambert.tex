...
% personal data
\name{Yann}{Lambert}
\title{Ingénieur Système GNU/Linux}
...
\section{Compétences}
\cvdoubleitem{GNU/Linux}{Gentoo, Debian, RedHat}{Switch}{Extreme}
\cvdoubleitem{Firewall}{NetScreen, Palo Alto, Fortinet}{BDD}{Mysql, PostgreSQL, Redis, Mongo}
\cvdoubleitem{Supervision}{Shinken, Nagios, Graphite, Grafana, Collectd}{Infrastructure}{GIT, Nginx, Apache, Bind, Postfix, DHCP, OpenLDAP, NTP, NFS, ELK}
\cvdoubleitem{Déploiement}{Puppet, FAI-project, Salt, Ansible}{Containers}{Docker}
...
\begin{itemize}
\item Migration de l'infrastructure du site ecommerce Drupal vers AWS (Cloudfront, EC2, S3, Auto Scaling Groups, Aurora, Redis, Solr, PHP, Nginx, Ansible)
\item Centralisation de la configuration des serveurs (Ansible)
...
\item Installation d'outils, notamment d'intégration continue pour les équipes de R\&D (Jenkins, Gitlab, Gerrit, Docker swarm)
